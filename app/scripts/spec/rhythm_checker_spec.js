...
describe("RhythmChecker", function() {
  it("converts durations to times - without rests", function() {
    ...
    const expectedTimes = [[0, 250], [250, 500], [500, 750], [750, 1250]];
  ...
  it("converts durations to times - with rests", function() {
    ...
    const times = RhythmChecker.convertDurationsToTimes(durations, 1000);
    const expectedTimes = [[0, 250], [500, 1000], [1000, 1250]];
  ...
  it("compares times within a given tolerance", function() {
    ...
    const givenTimesCorrect = [[0, 230], [560, 960], [970, 1300]];
    ...
    const givenTimesImprecise = [[0, 230], [290, 960], [970, 1300]];
    ...
    const givenTimesTooMany = [[0, 250], [500, 1000], [1000, 1250], [1250, 1500]];
    ...
    const givenTimesMissesBeat = [[0, 250], [500, 1000]];
